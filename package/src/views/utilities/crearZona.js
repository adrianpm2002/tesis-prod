...
const SuccessCard = ({ onClose }) => {  // <- Añade esta prop
  return (
    <StyledWrapper>
      <div className="success">
        ...
        <div className="success__title">Zona de Cultivo creada exitosamente</div>
        <div className="success__close" onClick={onClose}>  {/* <- Cierra el modal */}
